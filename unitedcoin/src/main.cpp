...
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // UnitedCoin: starting difficulty is 1 / 2^12
...
static const int64 nTargetTimespan = 1 * 60 * 60; // UnitedCoin: every 4 hours
static const int64 nTargetSpacing = 60; // UnitedCoin: 1 minutes
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal unitedcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "UnitedCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x05fdca94d7a8390a3f5c43b1097b02cb19d323178e2d52068338060606232020");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "I'm annoying someone";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1388726709;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1062155;
        ...
        assert(block.hashMerkleRoot == uint256("df1684874266800437212f5d21d0e4691d3fa8a24cce51593f7bc00993572e22"));
...
CBlock* CreateNewBlock(CReserveKey& reservekey)
{
    ...
    int64 nFees = 0;
    {
        ...
        while (!mapPriority.empty())
        {
            ...
            // UnitedCoind: Reduce the exempted free transactions to 500 bytes (from Bitcoin's 3000 bytes)
