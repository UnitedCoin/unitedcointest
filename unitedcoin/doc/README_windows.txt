...
If you have Microsoft Security Essentials, you need to add unitedcoin-qt.exe to its
"Excluded processes" list.  Microsoft Security Essentials->Settings tab,
select Excluded processes, press Add, select unitedcoin-qt.exe, OK, Save changes.
